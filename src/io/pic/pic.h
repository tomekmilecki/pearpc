...
#define IO_OPENPIC_PA_START 0x80840000
#define IO_OPENPIC_PA_END 0x80880000

/*
 *	interrupts < 32 and in this mask are level-triggered (20 <= irq <= 28)
...
#define IO_PIC_IRQ_CUDA		25
#define IO_PIC_IRQ_PMU_EXTINT	47
